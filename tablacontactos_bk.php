...
$sql="SELECT ID,NAME,LASTNAME,NICKNAME,PHONE,DNI,ADDRESS,LOCATION from person";
$result=mysqli_query($conexion,$sql);
?>

<div class="table table-responsive">
	<table class="table table-sm table-hover table-condensed table-bordered display dataTable_width_auto" id="iddatatable">
